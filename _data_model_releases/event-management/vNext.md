...
- Event Participants: New table to replace Event Attendees (more flexible to cover Judges, Speakers, etc.). Fields - Name, Event, Person
...
- Event Session Participants: New table, Fields - Name, Event Session, Person (Contact)
