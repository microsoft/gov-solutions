...
![alt text]({{ '/assets/solutions/core/navigation.png' | relative_url }})
...
![alt text]({{ '/assets/solutions/core/personnel-types.png' | relative_url }})
...
![alt text]({{ '/assets/solutions/core/organization-units.png' | relative_url }})

## Organization Unit Types

Organization Unit Types allow you to specify the various types of organization units at your agency.

![alt text]({{ '/assets/solutions/core/organization-unit-types.png' | relative_url }})
...
![alt text]({{ '/assets/solutions/core/organization-initiatives.png' | relative_url }})
...
![alt text]({{ '/assets/solutions/core/clearance-levels.png' | relative_url }})
...
![alt text]({{ '/assets/solutions/core/grade-ranks.png' | relative_url }})
...
![alt text]({{ '/assets/solutions/core/pay-grades.png' | relative_url }})
...
![alt text]({{ '/assets/solutions/core/job-series.png' | relative_url }})
...
![alt text]({{ '/assets/solutions/core/countries.png' | relative_url }})

## States or Provinces

![alt text]({{ '/assets/solutions/core/states.png' | relative_url }})

## Locations

![alt text]({{ '/assets/solutions/core/locations.png' | relative_url }})
...
![alt text]({{ '/assets/solutions/core/fiscal-periods.png' | relative_url }})
...
![alt text]({{ '/assets/solutions/core/products.png' | relative_url }})
...
![alt text]({{ '/assets/solutions/core/privacy-consents.png' | relative_url }})
...
![alt text]({{ '/assets/solutions/core/legal-authorities.png' | relative_url }})
...
![alt text]({{ '/assets/solutions/core/analyses.png' | relative_url }})
...
![alt text]({{ '/assets/solutions/core/impacts.png' | relative_url }})
...
![alt text]({{ '/assets/solutions/core/risk-items.png' | relative_url }})
...
![alt text]({{ '/assets/solutions/core/compliance-frameworks.pngpng' | relative_url }})
...
![alt text]({{ '/assets/solutions/core/compliance-framework-categories.png' | relative_url }})
...
![alt text]({{ '/assets/solutions/core/compliance-requirements.png' | relative_url }})
